...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2019 at 09:26 PM
...
CREATE TABLE `offers` (
  ...
  `promo_code` varchar(90) NOT NULL,
...
INSERT INTO `offers` (`id`, `percentage`, `promo_code`, `expiry`) VALUES
(5, 5, '62e2b', '2019-04-14');
...
(1, 'Datsun', '2019-04-09 05:02:25', NULL);
...
(2, 'Muhammad Abad', 'abad.developer@gmail.com', '9456868465', 'Hey i am dev', '2019-04-08 14:59:50', NULL);
...
(5, 'Muhammad Abad', 'abad@gmail.com', '6d03759b2873e182ec63bd89aa3693b8', '9456868465', NULL, NULL, NULL, NULL, '2019-04-07 11:00:46', NULL);
...
(1, 'Datsun Redi-GO', 1, 'Price	Rs. 2.67 Lakhs onwards\r\nMileage	22.5 to 23 kmpl\r\nEngine	799 to 999 cc\r\nTransmission	Manual and AMT', 2500, 'Petrol', 2018, 8, 'datsun-redi-go-amt-500x500.png', 'datsun-redi-go-right_600x300.jpg', 'Datsun-RediGO-Right-Front-Three-Quarter-91418.webp', 'images.jpg', 'kisspng-datsun-redi-go-gold-datsun-redi-go-a-india-datsun-nissan-car-5ac484a838e6a7.0349170515228284562331.jpg', 1, NULL, NULL, 1, 1, 1, NULL, 1, 1, NULL, NULL, 1, '2019-04-09 05:10:50', NULL);
